...
python -u app-command.py --name "timer4" --url "mihomo/tc.yaml" --mihomo-dir "open" --mihomo-config "scripts/mihomo-config/config-android-open.yaml" --singbox-dir "open" --singbox-config "scripts/singbox-config/config-android-open.json"
python -u app-command.py --name "timer4-linux" --url "mihomo/tc.yaml" --mihomo-dir "open" --mihomo-config "scripts/mihomo-config/config-linux-open.yaml" --singbox-dir "open" --singbox-config "scripts/singbox-config/config-linux-open.json"
python -u app-command.py --name "timer4-windows" --url "mihomo/tc.yaml" --mihomo-dir "open" --mihomo-config "scripts/mihomo-config/config-windows-open.yaml" --singbox-dir "open" --singbox-config "scripts/singbox-config/config-windows-open.json"
...
python -u app-command.py --name "timer2" --url "generate-preferred-nodes/config/output.txt" --mihomo-dir "open" --mihomo-config "scripts/mihomo-config/config-android-open.yaml" --singbox-dir "open" --singbox-config "scripts/singbox-config/config-android-open.json"
python -u app-command.py --name "timer2-linux" --url "generate-preferred-nodes/config/output.txt" --mihomo-dir "open" --mihomo-config "scripts/mihomo-config/config-linux-open.yaml" --singbox-dir "open" --singbox-config "scripts/singbox-config/config-linux-open.json"
python -u app-command.py --name "timer2-windows" --url "generate-preferred-nodes/config/output.txt" --mihomo-dir "open" --mihomo-config "scripts/mihomo-config/config-windows-open.yaml" --singbox-dir "open" --singbox-config "scripts/singbox-config/config-windows-open.json"